...
{
    VulkanPhysicalDevice::VulkanPhysicalDevice(const VulkanApplication* vulkanApplication)
    ...
    uint32_t VulkanPhysicalDevice::RatePhysicalDevice(VkPhysicalDevice device)
    {
    ...
    bool VulkanPhysicalDevice::CheckDeviceExtensionsSupport(VkPhysicalDevice device)
    {
